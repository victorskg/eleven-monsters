...
const bra2002 = squad("bra-2002", "BRA", 2002, "Brasil 2002", [
  ...
  p("bra-2002", "BRA", 2002, "junior", "Júnior", "LB", 84),
  ...
  p("bra-2002", "BRA", 2002, "denilson", "Denílson", "LW", 84),
  p("bra-2002", "BRA", 2002, "vampeta", "Vampeta", "RB", 80),
]);

const arg1986 = squad("arg-1986", "ARG", 1986, "Argentina 1986", [
  p("arg-1986", "ARG", 1986, "pumpido", "Pumpido", "GK", 87),
  p("arg-1986", "ARG", 1986, "batista", "Batista", "CB", 84),
  p("arg-1986", "ARG", 1986, "brown", "Brown", "CB", 86),
  ...
  p("arg-1986", "ARG", 1986, "brown-st", "Brown", "ST", 78),
  p("arg-1986", "ARG", 1986, "giusti", "Giusti", "CDM", 84),
]);
...
const ned1974 = squad("ned-1974", "NED", 1974, "Holanda 1974", [
  ...
  p("ned-1974", "NED", 1974, "rijnsoever", "Rijnsoever", "CB", 85),
  p("ned-1974", "NED", 1974, "haan", "Haan", "CB", 87),
  p("ned-1974", "NED", 1974, "suurbier", "Suurbier", "RB", 86),
  p("ned-1974", "NED", 1974, "jansen", "Jansen", "CDM", 84),
  p("ned-1974", "NED", 1974, "nageleer", "Neeskens", "CM", 91, { passing: 90 }),
  p("ned-1974", "NED", 1974, "van-hanegem", "van Hanegem", "CM", 89),
  p("ned-1974", "NED", 1974, "cruyff", "Cruyff", "CAM", 97, { passing: 96 }),
  p("ned-1974", "NED", 1974, "rep", "Rep", "ST", 92, { shooting: 93 }),
  p("ned-1974", "NED", 1974, "swart", "Swart", "RW", 84),
]);

const uru1950 = squad("uru-1950", "URU", 1950, "Uruguai 1950", [
  p("uru-1950", "URU", 1950, "mazurkiewicz", "Mazurkiewicz", "GK", 84),
  p("uru-1950", "URU", 1950, "tejera", "Tejera", "RB", 80),
  p("uru-1950", "URU", 1950, "matosas", "Matosas", "CB", 82),
  p("uru-1950", "URU", 1950, "emilio", "Emilio", "CB", 81),
  p("uru-1950", "URU", 1950, "moran", "Morán", "LB", 79),
  p("uru-1950", "URU", 1950, "andrade", "Andrade", "CM", 88, { passing: 89 }),
  p("uru-1950", "URU", 1950, "vidal", "Vidal", "CM", 85),
  p("uru-1950", "URU", 1950, "ghiggia", "Ghiggia", "RW", 90, { pace: 91 }),
  p("uru-1950", "URU", 1950, "miguez", "Míguez", "ST", 87),
  p("uru-1950", "URU", 1950, "schiaffino", "Schiavio", "ST", 86),
  p("uru-1950", "URU", 1950, "borges", "Borges", "LW", 83),
]);
...
const eng1966 = squad("eng-1966", "ENG", 1966, "Inglaterra 1966", [
  ...
  p("eng-1966", "ENG", 1966, "wilson", "Wilson", "CB", 85),
  p("eng-1966", "ENG", 1966, "wilson-lb", "Wilson", "LB", 82),
  ...
  p("eng-1966", "ENG", 1966, "connelly", "Connelly", "LW", 82),
...
const gre2004 = squad("gre-2004", "GRE", 2004, "Grécia 2004", [
  ...
  p("gre-2004", "GRE", 2004, "fysas", "Fyssas", "LB", 79),
  p("gre-2004", "GRE", 2004, "zagorakis", "Zagorakis", "CM", 87),
  p("gre-2004", "GRE", 2004, "basinas", "Basinas", "CM", 81),
  p("gre-2004", "GRE", 2004, "vryzas", "Vryzas", "CAM", 80),
  p("gre-2004", "GRE", 2004, "charisteas", "Charisteas", "ST", 84),
  p("gre-2004", "GRE", 2004, "gkalas", "Gkalas", "ST", 76),
  p("gre-2004", "GRE", 2004, "papadopoulos", "Papadopoulos", "LW", 74),
]);

const cmr1990 = squad("cmr-1990", "CMR", 1990, "Camarões 1990", [
  p("cmr-1990", "CMR", 1990, "bell", "Bell", "GK", 78),
  p("cmr-1990", "CMR", 1990, "kunde", "Kundé", "RB", 80),
  p("cmr-1990", "CMR", 1990, "massing", "Massing", "CB", 79),
  p("cmr-1990", "CMR", 1990, "kana", "Kana", "CB", 77),
  p("cmr-1990", "CMR", 1990, "ebbe", "Ebbé", "LB", 75),
  p("cmr-1990", "CMR", 1990, "emmanuel", "Emmanuel", "CM", 76),
  p("cmr-1990", "CMR", 1990, "milla", "Milla", "CAM", 88, { shooting: 87 }),
  p("cmr-1990", "CMR", 1990, "mbouh", "Mbouh", "CM", 74),
  p("cmr-1990", "CMR", 1990, "koman", "Koman", "LW", 78),
  p("cmr-1990", "CMR", 1990, "makoge", "Makoge", "ST", 75),
  p("cmr-1990", "CMR", 1990, "omam", "Omam", "ST", 73),
]);

const usa1994 = squad("usa-1994", "USA", 1994, "EUA 1994", [
  p("usa-1994", "USA", 1994, "friedel", "Friedel", "GK", 76),
  p("usa-1994", "USA", 1994, "dooley", "Dooley", "RB", 74),
  p("usa-1994", "USA", 1994, "lalas", "Lalas", "CB", 75),
  p("usa-1994", "USA", 1994, "balboa", "Balboa", "CB", 77),
  p("usa-1994", "USA", 1994, "pearlman", "Pearlman", "LB", 72),
  p("usa-1994", "USA", 1994, "tabram", "Tabram", "CM", 73),
  p("usa-1994", "USA", 1994, "stewart", "Stewart", "CM", 74),
  p("usa-1994", "USA", 1994, "wynalda", "Wynalda", "CAM", 78),
  p("usa-1994", "USA", 1994, "lalas-st", "Lalas", "ST", 70),
  p("usa-1994", "USA", 1994, "wegerle", "Wegerle", "ST", 79),
  p("usa-1994", "USA", 1994, "cobi", "Cobi Jones", "RW", 76),
]);

const por1966 = squad("por-1966", "POR", 1966, "Portugal 1966", [
  p("por-1966", "POR", 1966, "peres", "Peres", "GK", 82),
  p("por-1966", "POR", 1966, "morais", "Morais", "RB", 80),
  p("por-1966", "POR", 1966, "hilario", "Hilário", "CB", 81),
  p("por-1966", "POR", 1966, "vicente", "Vicente", "CB", 79),
  p("por-1966", "POR", 1966, "graca", "Graça", "LB", 78),
  p("por-1966", "POR", 1966, "coluna", "Coluna", "CM", 88, { passing: 89 }),
  p("por-1966", "POR", 1966, "simoes", "Simões", "CM", 84),
  p("por-1966", "POR", 1966, "eusebio", "Eusébio", "ST", 95, { shooting: 96, pace: 93 }),
  p("por-1966", "POR", 1966, "torres", "Torres", "ST", 83),
  p("por-1966", "POR", 1966, "augusto", "Augusto", "LW", 82),
  p("por-1966", "POR", 1966, "jaime", "Jaime", "RW", 80),
]);
